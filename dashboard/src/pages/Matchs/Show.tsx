...
import { deleteMatch, fetchMatches, fetchTeams, type Match } from "./Create";
...
export default function ShowMatches() {
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeletingId(id);
    const resultAction = await dispatch(deleteMatch(id));
    setDeletingId(null);
    ...
    await loadMatches(pagination.page, pagination.size || ITEMS_PER_PAGE);
  };
