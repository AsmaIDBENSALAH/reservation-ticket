...
public interface CompetitionRepository extends JpaRepository<Competition, UUID> {
        ...
        Page<Competition> findByActiveTrueAndScopeAndContinent(CompetitionScope scope, Continent continent,
                        Pageable pageable);

        Page<Competition> findByActiveTrueAndScopeAndCountryId(CompetitionScope scope, UUID countryId,
                        Pageable pageable);

        Page<Competition> findByActiveTrueAndScopeAndCountriesIdIn(CompetitionScope scope, List<UUID> countryIds,
                        Pageable pageable);
